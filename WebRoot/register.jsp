...
<html>
 ...
 //验证用户名规范
  ...
  var name1=document.myform.UserName.value;
  ...
  else
  {
    ...
    if(firstchar>="0"&&firstchar<="9")
        {
        obj.innerHTML="用户名必须为以字母开头！";
		alert("用户名必须为以字母开头！");
		return false;
        }else{
				if(name1.length<6||name1.length>10){
				obj.innerHTML="名字长度必须大于六位小于十位！";
				 alert("名字长度必须大于六位小于十位！");
				 return false;
				  							}        
             }
  }
  ...
  var obj=document.getElementById("err_password");
  obj.innerHTML="";
  if(pwd1==""||pwd1==null)
  {
  ...
  else
  {
				...
				obj.innerHTML="密码长度必须大于六位小于十位！";
				 alert("密码长度必须大于六位小于十位！");
				 return false;
				  							}        
             }
  }
...
<tr>
   <td>
	...
	<td>
	<input type="text" name="UserName" value="" onblur="checkUsername();">
     </td>
     <td>
...
密&nbsp;&nbsp; &nbsp;码:&nbsp;&nbsp;&nbsp;
	...
	<td>
<input type="text" name="Password" value="" onblur="checkPassword();">
</td>
     <td>
